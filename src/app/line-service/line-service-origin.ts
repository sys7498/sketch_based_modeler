...
//        if (minPointDistance < this.scale / 3) {
...
//            });
//            console.log(targetLines.map((line) => line.updatedConvertedLength));
//        }
//        if (
//            targetLines.every((line) => line.updatedConvertedLength === false)
//        ) {
//            console.log(targetLines[0].name);
...
//    }
//
//    /** edge로 연결된 line의 converted length를 계산할 수 있는 조건이 되면 계산 */
...
//                console.log(connectedLine0.line.myPoints);
//                console.log(connectedLine1.line.myPoints);
//                if (
...
//                ) {
//                    console.log(connectedLine0, connectedLine1);
//                    if (
//                        connectedLine0.line.myPoints.every(
//                            (myPoint) => myPoint.updated
//                        ) &&
//                        connectedLine1.line.myPoints.every(
//                            (myPoint) => myPoint.updated
//                        )
//                    ) {
...
//                        let check = connectedLine.line.connectedEdgeLines.find(
//                            (edgeLine) => {
//                                return edgeLine.point === targetPoint;
//                            }
//                        );
//                        if (check.line.updatedConvertedLength) {
